...
class _GridAttentionBlockND(nn.Module):
    ...
    def _concatenation(self, x, g):
        ...
        phi_g = F.upsample(self.phi(g), size=theta_x_size[2:], mode=self.upsample_mode, align_corners=False)
        ...
        sigm_psi_f = F.upsample(sigm_psi_f, size=input_size[2:], mode=self.upsample_mode, align_corners=False)
